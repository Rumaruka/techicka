...
import com.rumaruka.techicka.common.modules.thermal.BloodDynamoBlock;
import com.rumaruka.techicka.common.modules.thermal.bloodmagic.inventory.BloodDynamoContainer;
import com.rumaruka.techicka.common.modules.thermal.BloodDynamoTile;
...
public class TBloodMagic {
    ...
    public static final DeferredRegisterCoFH<IRecipeSerializer<?>> RECIPES = DeferredRegisterCoFH.create(ForgeRegistries.RECIPE_SERIALIZERS, MODID);
    public static final DeferredRegister<Fluid> FLUIDST
    ...
    public static void setup() {
        ...
        FLUIDST.register(FMLJavaModLoadingContext.get().getModEventBus());
    ...
    public static final RegistryObject<ContainerType<BloodDynamoContainer>> BLOOD_DYNAMO_CONTAINER = CONTAINERS.register("blood_dynamo", () -> IForgeContainerType.create((windowId, inv, data) -> {

        return new BloodDynamoContainer(windowId, ProxyUtils.getClientWorld(), data.readBlockPos(), inv, ProxyUtils.getClientPlayer());
    }));
